...
// 17. Using cout and p2 only, display the address of the first element in a.
    cout << "#17: The address of the first element is " << &p2[0] << endl;
...
//     (The first element should be 99, the second 0).
    cout << "#20: The first element in a[] is " << *p1;
    cout << " and the second element in a[] is " << *p2 << endl;
